...
<div class="formLogin">
    <div id="auto">
        <form action="../dengLu.do" name="administrator_Login_Form" id="administrator_Login_Form" method="post">
            <div id="margin_top"> 登录 </div>
            <div class="username_div">
                <img class="float_left" src="../img/user_img.jpg"/>
                <div class="float_left emm">用户名：</div>
                <input  type="text" class="float_left username_div_input" name="username" placeholder="请输入帐户名或手机号" value=""/>
            </div>
            <div class="username_div">
                <img class="float_left" src="../img/lock.png"/>
                <div class="float_left emm">密&nbsp;&nbsp;&nbsp;码：</div>
                <input type="password" class="username_div_input float_left" name="password" placeholder="请输入密码" value=""/>
            </div>
