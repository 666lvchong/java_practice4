...
//        return rows;
    ...
    public Integer saveOrUpdate(ActivityRelation activityRelation) throws SQLException {
        ...
        if (activityRelation.getId() != null){
            return super.sqlSessionTemplate.update(getMybaitsNameSpace()+"update",activityRelation);
//            //定义sql语句
...
//            commit();
            ...
            return super.sqlSessionTemplate.insert(getMybaitsNameSpace()+"save",activityRelation);
//            //定义sql语句
