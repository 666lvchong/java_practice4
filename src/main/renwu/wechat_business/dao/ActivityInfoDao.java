...
//        return rows;
    ...
    *//**
    ...
    public Integer deleteByIds(Long[] ids) throws SQLException {
        if (ids.length > 0){
            rows=sqlSessionTemplate.delete(getMybaitsNameSpace()+"deleteByIds",ids);
    ...
    *//**
    ...
    public Integer saveOrUpdate(ActivityInfo activityInfo) throws SQLException {
        ...
        if (activityInfo.getId() != null){
            return sqlSessionTemplate.update(getMybaitsNameSpace()+"update",activityInfo);
//            //定义sql语句
...
//            commit();
            ...
            return sqlSessionTemplate.insert(getMybaitsNameSpace()+"save",activityInfo);
//            //定义sql语句
