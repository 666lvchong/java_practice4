...
-- 2018年2月8日15:18:25 何鸿举  地址信息 主键ID,淘宝户，地址类型 地址
DROP TABLE IF EXISTS ADDRESS;
CREATE TABLE ADDRESS(
	ID BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '主键ID',
	TAOBAO_ACCOUNT_ID BIGINT  COMMENT '淘宝账户' REFERENCES TAOBAO_ACCOUNT(ID) ,
	ADDRESS_TYPE TINYINT(2) COMMENT '地址类型 1-收货地址，2-发货地址 3-运输地址',
	ADDRESS VARCHAR(200) NOT NULL COMMENT '地址',
	LINKMAN_CONTACTS VARCHAR(30) COMMENT '联系人',
	TELEPHONE VARCHAR(30) COMMENT '联系电话',
	CREATE_TIME DATETIME COMMENT '创建时间 yyyy-MM-dd HH:mm:ss',
	UPDATE_TIME DATETIME COMMENT '更新时间 yyyy-MM-dd HH:mm:ss',
	IS_DEFAULT TINYINT(1) COMMENT '是否默认地址 1-是 0--否'
...
CREATE TABLE ORDER_INFO(
	ID BIGINT AUTO_INCREMENT PRIMARY KEY COMMENT '主键ID',
	ORDER_NUM VARCHAR(200) NOT NULL COMMENT '订单编号',
	...
	TRADING_TIME DATETIME  COMMENT '交易成功时间 yyyy-MM-dd HH：mm：ss',
	IS_SUCCESS TINYINT(1) NOT NULL COMMENT '是否交易成功，1--是，0--否',
	ADDRESS_ID BIGINT COMMENT '收货地址' REFERENCES ADDRESS_INFO(ID)
...
CREATE TABLE ORDER_DETAIL(
	...
	IS_RECEIVED  TINYINT(1) NOT NULL COMMENT '收货状态 1--收货 0--未收货',
	IS_RETURNED  TINYINT(1) NOT NULL COMMENT '退货状态 1--退货 0--未退货',
	...
	ADDRESS_ID BIGINT COMMENT '发货地址' REFERENCES ADDRESS_INFO(ID)
...
CREATE TABLE ITEM_RELATION(
	...
	IMG_ADDR VARCHAR(100) COMMENT '图片地址'
